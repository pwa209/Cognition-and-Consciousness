...
| Masked-content fMRI | OpenNeuro `ds003927` v1.0.3, Git SHA `1f62eb6…` | Public, CC0 | 153.3 GB | GraphQL resolves versioned S3 URLs; concurrent resumable download to NAS |
...
| Propofol volition fMRI | OpenNeuro `ds006623` v1.0.0, Git SHA `9c36d2c…` | Public, CC0 | 34.1 GB | Versioned S3 inventory and resumable NAS download |
...
| Propofol awakening EEG/TMS-EEG | OpenNeuro `ds005620` v1.0.0, Git SHA `a7ee507…` | Public, CC0 | 83.0 GB | Versioned S3 inventory and resumable NAS download |
